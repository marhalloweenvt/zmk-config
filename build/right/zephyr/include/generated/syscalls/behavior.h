...
#define behavior_sensor_keymap_binding_accept_data(binding, event, sensor_config, channel_data_size, channel_data) ({ 	int retval; 	sys_port_trace_syscall_enter(K_SYSCALL_BEHAVIOR_SENSOR_KEYMAP_BINDING_ACCEPT_DATA, behavior_sensor_keymap_binding_accept_data, binding, event, sensor_config, channel_data_size, channel_data); 	retval = behavior_sensor_keymap_binding_accept_data(binding, event, sensor_config, channel_data_size, channel_data); 	sys_port_trace_syscall_exit(K_SYSCALL_BEHAVIOR_SENSOR_KEYMAP_BINDING_ACCEPT_DATA, behavior_sensor_keymap_binding_accept_data, binding, event, sensor_config, channel_data_size, channel_data, retval); 	retval; })
#endif
#endif
...
#define behavior_sensor_keymap_binding_process(binding, event, mode) ({ 	int retval; 	sys_port_trace_syscall_enter(K_SYSCALL_BEHAVIOR_SENSOR_KEYMAP_BINDING_PROCESS, behavior_sensor_keymap_binding_process, binding, event, mode); 	retval = behavior_sensor_keymap_binding_process(binding, event, mode); 	sys_port_trace_syscall_exit(K_SYSCALL_BEHAVIOR_SENSOR_KEYMAP_BINDING_PROCESS, behavior_sensor_keymap_binding_process, binding, event, mode, retval); 	retval; })
#endif
#endif
